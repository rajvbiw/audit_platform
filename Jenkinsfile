pipeline {
    ...
    environment {
        ...
        PROJECT_DIR = "D:\\devops\\NEW_PROJECT_FILE\\15projects30days\\project_7\\audit_platform"
        COMPOSE_FILE = "D:\\devops\\NEW_PROJECT_FILE\\15projects30days\\project_7\\audit_platform\\docker-compose.yml"
        K8S_DIR = "D:\\devops\\NEW_PROJECT_FILE\\15projects30days\\project_7\\audit_platform\\kubernetes"
        
        COMPOSE_PROJECT_NAME = "audit-platform"
            ...
            steps {
                dir(env.PROJECT_DIR) {
                    ...
                    script {
                        ...
                        bat 'docker rm -f audit-backend audit-frontend audit-db audit-worker audit-redis 2>nul || exit 0'
                    }
                ...
                dir(env.PROJECT_DIR) {
                    ...
                    script {
                        try {
                            ...
                            bat 'kubectl rollout status deployment/audit-backend -n %NAMESPACE% --timeout=90s'
                            bat 'kubectl rollout status deployment/audit-frontend -n %NAMESPACE% --timeout=90s'
